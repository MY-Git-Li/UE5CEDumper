...
|      +-- Aura     (ObjectArray)   <- Chunked + Flat arrays + Find Refs/Containers + ScanForValue (lean Candidate V3-A 926; TSet/TMap scan V1a 927) + FindObjectGraphPath (GWorld fwd BFS / Locate in GWorld, 1181) |
