# Dev Log archive — builds 1178 – 1799 (2026-06-22 … 2026-06-26)

Archived from `../dev-log.md` on 2026-07-20 when the live log passed 400 KB.
Newest first, same format as the live log. Nothing here was edited — only moved.

**Where the rest lives:** builds **1800+** in [`../dev-log.md`](../dev-log.md);
builds 939–1177 in [`dev-log-2026-06-pre-build-1180.md`](dev-log-2026-06-pre-build-1180.md);
builds 715–937 in [`dev-log-2026-06-pre-build-940.md`](dev-log-2026-06-pre-build-940.md);
builds ≤696 in [`dev-log-2026-05-pre-build-700.md`](dev-log-2026-05-pre-build-700.md).

> Relative links inside these entries were written for `docs/` — from this folder
> they resolve one level up (`../ui/...`, `../dll/...`, `roadmap.md` → `../roadmap.md`).
