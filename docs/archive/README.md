...
| `dev-log-2026-06-pre-build-1800.md` | Builds 1178–1799 of the running milestone log (2026-06-22 … 2026-06-26) | Split out on 2026-07-20 when `dev-log.md` passed 400 KB — the file is append-only and grep-first, so the older two-thirds were moved to keep the live log readable. **Nothing was edited, only moved.** The live log keeps builds 1800+. |
