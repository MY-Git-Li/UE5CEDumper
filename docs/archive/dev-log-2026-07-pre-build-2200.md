# Dev Log — archived (builds 1800–2168)

Split out of [`../dev-log.md`](../dev-log.md) on 2026-08-05 when the live file passed
400 KB for the second time. **Nothing was edited, only moved.** The live log keeps
builds 2200+; builds 1178–1799 are in
[`dev-log-2026-06-pre-build-1800.md`](dev-log-2026-06-pre-build-1800.md).

Newest-first, same as the live log. Grep `^## ` for the index.
