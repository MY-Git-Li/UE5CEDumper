...
| P5 | `[SUMMARY]` | `init` | Build / UE version / the three globals / DynOff validation / UStruct+FField+FProperty offsets. Six lines, no category field. Answers **[FPROPERTY_FLAGS]** on sight. |
