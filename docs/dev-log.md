...
## 2026-06-20 — CE-Field follow-up (a): Map/Set (and interface-array) element hops in a GWorld-path spine now split into container + element crumbs (builds 1389-1390; DLL + pipe + UI; dev)
