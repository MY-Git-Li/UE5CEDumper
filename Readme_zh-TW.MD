...
| **4.25 – 4.27** | ✅ | ✅ | ✅ | *Final Fantasy VII Rebirth, Tower of Mask, 霍格華茲的傳承, 復活邪神 2 七英雄的復仇, Ghostwire: Tokyo, TimeSplitters Rewind (Early Access V0.3.3), The Artisan of Glimmith* |
...
* **GWorld 連通性**: `GWorld` 遍歷在約 96% 的實測遊戲中可正常運作（26 款中有 25 款）。若無法運作，請改用 **Object Tree** 或 **Instance Finder** 作為主要進入點。
