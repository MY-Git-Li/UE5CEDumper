...
| **5.5 – 5.7** | ✅ | ✅* | ✅** | *泰坦任務 2, EverSpace 2, Lushfoil Photography Sim, 莊園領主 (Manor Lords), Cat Island Petrichor Demo, Way of the Hunter 2 Demo, COMBAT PILOT: CARRIER QUALIFICATION Demo, Solarpunk (太陽龐克, stock UE5.7 — Object@+0x08), Satisfactory (滿意工廠 v1.2 — UE5.6；modular build，全域指標皆經 symbol export，217 K 物件)* |
