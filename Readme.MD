...
| **4.25 – 4.27** | ✅ | ✅ | ✅ | *FF7 Rebirth, Tower of Mask, Hogwarts Legacy, Romancing SaGa 2 RotS, Ghostwire: Tokyo, TimeSplitters Rewind (Early Access V0.3.3), The Artisan of Glimmith* |
...
* **GWorld Connectivity**: `GWorld` traversal works in ~96% of tested games (25 of 26). For the remainder, use the **Object Tree** or **Instance Finder** as the primary entry point.
