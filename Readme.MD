...
* **GWorld Connectivity**: `GWorld` traversal works in ~97% of tested games (28 of 29). For the remainder, use the **Object Tree** or **Instance Finder** as the primary entry point.
