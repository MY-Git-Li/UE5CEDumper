...
public class StubDumpService : IDumpService
{
    ...
    public virtual Task<GroupScanBeginResult> BeginGroupScanAsync(IReadOnlyList<GroupSlotInput> slots, bool gameOnly = true, int maxResults = 50000, bool deep = false, int pageSize = 1000, CancellationToken ct = default) => throw new NotImplementedException();
