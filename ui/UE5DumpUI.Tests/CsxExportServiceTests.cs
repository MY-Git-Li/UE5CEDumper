...
public class StubDumpService : IDumpService
{
    ...
    public virtual Task<FindInstancesResult> FindInstancesAsync(string className, bool exactMatch = false, int limit = 500, bool newestFirst = false, CancellationToken ct = default) => throw new NotImplementedException();
    ...
    public Task<PropertySearchResult> SearchPropertiesAsync(string query, string[]? types = null, bool gameOnly = true, bool deep = false, int limit = 200, CancellationToken ct = default) => throw new NotImplementedException();
    ...
    public virtual Task<ValueScanBeginResult> BeginValueScanAsync(ValueScanDataType dataType, ValueScanType scanType, string value, string? value2 = null, bool gameOnly = true, int maxResults = 50000, double tolerance = 0.0, bool caseSensitive = false, bool parallel = true, bool batchRead = true, bool deep = false, bool nativeC = false, bool newestFirst = false, int pageSize = 1000, CancellationToken ct = default) => throw new NotImplementedException();
    public virtual Task<ValueScanRefineResult> RefineValueScanAsync(ulong sessionId, ValueScanType scanType, string? value = null, string? value2 = null, double tolerance = 0.0, bool caseSensitive = false, int pageSize = 1000, CancellationToken ct = default) => throw new NotImplementedException();
    public virtual Task<ValueScanWindowResult> QueryCandidatesAsync(ulong sessionId, int offset, int limit, string? filter = null, string? sortKey = null, bool sortDesc = false, CancellationToken ct = default) => throw new NotImplementedException();
    public virtual Task EndValueScanAsync(ulong sessionId, CancellationToken ct = default) => throw new NotImplementedException();
    public virtual Task<GroupScanBeginResult> BeginGroupScanAsync(IReadOnlyList<GroupSlotInput> slots, bool gameOnly = true, int maxResults = 50000, bool deep = false, bool crossObject = false, bool nativeC = false, bool newestFirst = false, int pageSize = 1000, CancellationToken ct = default) => throw new NotImplementedException();
    public virtual Task<GroupScanRefineResult> RefineGroupScanAsync(ulong sessionId, IReadOnlyList<GroupSlotInput> slots, int pageSize = 1000, CancellationToken ct = default) => throw new NotImplementedException();
    public virtual Task<GroupScanWindowResult> QueryGroupCandidatesAsync(ulong sessionId, int offset, int limit, string? filter = null, string? sortKey = null, bool sortDesc = false, CancellationToken ct = default) => throw new NotImplementedException();
    ...
    public virtual Task<SnapshotChunkResult> SnapshotChunkAsync(string dataType, bool gameOnly, int offset, int limit, CancellationToken ct = default) => throw new NotImplementedException();
