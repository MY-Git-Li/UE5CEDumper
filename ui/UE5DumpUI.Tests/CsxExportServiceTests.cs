...
public class StubDumpService : IDumpService
{
    ...
    public virtual Task<GroupScanRefineResult> RefineGroupScanAsync(ulong sessionId, IReadOnlyList<string> values, int pageSize = 1000, CancellationToken ct = default) => throw new NotImplementedException();
