...
public class StubDumpService : IDumpService
{
    ...
    public virtual Task<ValueScanBeginResult> BeginValueScanAsync(ValueScanDataType dataType, ValueScanType scanType, string value, string? value2 = null, bool gameOnly = true, int maxResults = 50000, CancellationToken ct = default) => throw new NotImplementedException();
    public virtual Task<ValueScanRefineResult> RefineValueScanAsync(ulong sessionId, ValueScanType scanType, string? value = null, string? value2 = null, CancellationToken ct = default) => throw new NotImplementedException();
