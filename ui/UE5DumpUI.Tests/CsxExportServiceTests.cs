...
public class StubDumpService : IDumpService
{
    ...
    public virtual Task<GWorldPathResult> FindPathFromGWorldAsync(string target, string? objectAddr = null, int maxDepth = 5, CancellationToken ct = default) => throw new NotImplementedException();
