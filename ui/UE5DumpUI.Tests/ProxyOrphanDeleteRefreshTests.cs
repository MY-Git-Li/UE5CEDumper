...
public class ProxyOrphanDeleteRefreshTests
{
    ...
    private sealed class StubProxyDeployService : IProxyDeployService
    {
        ...
        public Task RefreshDeployStatusAsync(IList<DetectedGame> games, string sourceDllPath, ProxyType proxyType, CancellationToken ct = default) => Task.CompletedTask;
