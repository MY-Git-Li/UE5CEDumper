...
public static class TeleportScriptGenerator
{
    ...
    public enum Action { Save, Recall, Cursor }
    ...
    /// <summary>Build the standard 7-row .CT batch (Save 1-3, Recall 1-3,
    /// Cursor) ready for <see cref="CheatTableBuilder.Build"/>.</summary>
